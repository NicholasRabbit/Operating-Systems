...
A kernel is a special programme which provides services to run programmes in user space. Each running programme, which is called a process, has memory containing **instructions, data and a stack.**  

1. **The instructions** implement the programme's computation. For instance, the assembly code generated by compiler from a C programme.
...
Each running programme, called a process, has memory containing instructions, data, and a stack. 
